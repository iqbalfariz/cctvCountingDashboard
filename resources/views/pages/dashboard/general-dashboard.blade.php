...
@section('main')
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            ...
                            <div wire:pool.5s class="card-body">
                                {{ $countings->last()->in }}
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            <div class="card-header">
                                <h4>Sisa Ruas Parkir</h4>
                            </div>
                            <div class="card-body">
                                {{ $countings->last()->total }}
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        function autoRefresh() {
            location.reload(true); // True parameter mengindikasikan reload dari server, bukan dari cache
        }

        // Memulai pembaruan otomatis setiap satu menit
